##############################################################################
#
# This is based on the Makefile distributed with ChibiOS, located at:
#    ChibiOS_2.6.5.zip/demos/ARMCM4-STM32F429-DISCOVERY/Makefile
#
#
##############################################################################
...
CHIBIOS = $(BUILDROOT)/stm32/ChibiOS
...
#TRGT = arm-elf-
TRGT = $(BIN_DIR)arm-none-eabi-
CC   = $(TRGT)gcc
CPPC = $(TRGT)g++
# Enable linking with g++ only if you need C++ runtime support.
